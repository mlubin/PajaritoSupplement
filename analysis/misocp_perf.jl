...
performance_profile(time_table[:,[5,7]], ["CPLEX","MSD_CPLEX_MOSEK"], logscale=false, ymax=1.0, xmax=15, linewidth=3)
Plots.savefig(joinpath(dirname(@__FILE__),"misocp_comm_time.tex"))

performance_profile(time_table[:,[1,2]], ["BONMIN_best","iter_CBC_ECOS"], logscale=false, ymax=1.0, xmax=15, linewidth=3)
