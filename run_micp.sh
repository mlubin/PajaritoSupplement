...
# ## SOC
# for SOLVER in PAJ_CPLEX_SCS PAJ_CPLEX_ECOS PAJ_CPLEX_MOSEK PAJ_CPLEX_MOSEK_msd PAJ_CPLEX_noconic PAJ_CPLEX_noconic_msd
# do
#     $JULIA scripts/runmeta.jl $SOLVER 7200 50000000 instancedata/micptests/soc/ instancesets/micp_soc.txt
# done
...
# do
#     $JULIA scripts/runmeta.jl $SOLVER 7200 50000000 instancedata/micptests/socexp/ instancesets/micp_socexp.txt
# done
