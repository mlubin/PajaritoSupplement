...
Plots.savefig(joinpath(dirname(@__FILE__),"sepcuts_time.tex"))

performance_profile(itercount_table, ["iter subp","iter sep","MSD subp","MSD sep"],logscale=false, ymax=1.0, xmax=5, linewidth=3)
Plots.savefig(joinpath(dirname(@__FILE__),"sepcuts_iter.tex"))
