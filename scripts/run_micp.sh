...
# for SOLVER in PAJ_Gurobi_msd_sep PAJ_Gurobi_sep PAJ_Gurobi_MOSEK_msd PAJ_Gurobi_MOSEK PAJ_Gurobi_MOSEK_msd_subponly_noinit PAJ_Gurobi_MOSEK_subponly_noinit PAJ_Gurobi_MOSEK_msd_nodisagg_subponly_noinit PAJ_Gurobi_MOSEK_nodisagg_subponly_noinit PAJ_Gurobi_MOSEK_msd_noinit PAJ_Gurobi_MOSEK_noinit PAJ_Gurobi_MOSEK_msd_noscale_subponly_noinit PAJ_Gurobi_MOSEK_noscale_subponly_noinit PAJ_Gurobi_MOSEK_msd_scaleup_subponly_noinit PAJ_Gurobi_MOSEK_scaleup_subponly_noinit PAJ_Gurobi_MOSEK_msd_scale_subponly_noinit PAJ_Gurobi_MOSEK_scale_subponly_noinit
for SOLVER in PAJ_Gurobi_MOSEK_msd_scaleup PAJ_Gurobi_MOSEK_scaleup PAJ_Gurobi_MOSEK_msd PAJ_Gurobi_MOSEK
do
